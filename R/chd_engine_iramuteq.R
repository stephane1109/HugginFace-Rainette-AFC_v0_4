...
.obtenir_fonction_iramuteq <- function(nom_fonction,
                                       chemin_module = "R/chd_iramuteq_bridge.R",
                                       env = parent.frame()) {
  ...
  candidats <- unique(c(
    chemin_module,
    file.path("R", "chd_iramuteq_bridge.R"),
    ...
    if (nzchar(racine_depuis_fichier)) file.path(racine_depuis_fichier, "R", "chd_iramuteq_bridge.R") else "",
    if (!is.null(racine_projet) && nzchar(racine_projet)) file.path(racine_projet, "iramuteq-like", "chd_iramuteq.R") else "",
    if (!is.null(racine_projet) && nzchar(racine_projet)) file.path(racine_projet, "R", "chd_iramuteq_bridge.R") else "",
    file.path(".", "iramuteq-like", "chd_iramuteq.R"),
    file.path(".", "R", "chd_iramuteq_bridge.R"),
    file.path(getwd(), "iramuteq-like", "chd_iramuteq.R"),
    file.path(getwd(), "R", "chd_iramuteq_bridge.R")
  ))
